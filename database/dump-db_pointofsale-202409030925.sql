...
INSERT INTO `tbl_mst_role` VALUES (18,'DEVELOPER','DEV','2024-06-12 13:00:00',NULL,1,NULL,NULL);
...
INSERT INTO `tbl_mst_users` VALUES (13,'dev','dev','$2y$10$UL5rkiGSP/OYybe8zOOkxeLXH7r1NvPEJsVHL3NJHWiN1oBfVEPju',14,'d@mail.com','083821619460',0,1,'2024-07-12 13:00:30',NULL,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=719 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_sys_menu` VALUES ('MN-0001','1','0','*','Dashboard','fa fa-dashboard','administrator/dashboard',1),('MN-0002','1','1','*','Master','fa fa-cube','#',1),('MN-0002A','1','2','MN-0002','Gudang','#','administrator/warehouse',1),('MN-0002B','1','2','MN-0002','Rak/Location','#','administrator/location',1),('MN-0002C','1','2','MN-0002','Kategori','#','administrator/category',1),('MN-0002D','1','2','MN-0002','Unit','#','administrator/units',1),('MN-0002E','1','2','MN-0002','Item','#','administrator/material',1),('MN-0002F','1','2','MN-0002','Level Member','#','administrator/levelmember',1),('MN-0002G','1','2','MN-0002','Member','#','administrator/member',0),('MN-0003','1','1','*','Transaksi','fa fa-users','#',1),('MN-0003A','1','2','MN-0003','Input Penjualan','#','administrator/penjualan',1),('MN-0003B','1','2','MN-0003','Input Pembelian','#','administrator/pembelian',1),('MN-0004','1','1','*','Laporan','fa fa-file-pdf-o','#',1),('MN-0004A','1','1','MN-0004','Penjualan','#','administrator/reportOut',1),('MN-0004B','1','1','MN-0004','Pembelian','#','administrator/reportOut',1),('MN-0004C','1','2','MN-0004','Stock Item','#','administrator/stock',1);
...
INSERT INTO `tbl_trn_detail_sales` VALUES (44,'2024-09-03 00:00:00',19,12,'Ale-Ale',1,'PCS','AL092','Ale Ale',900,4,0,'2024-09-03 07:14:37','13',NULL,NULL);
...
INSERT INTO `tbl_trn_header_trans` VALUES (19,'2024-09-03 07:14:37',1,'out','sales','TRN.092403.1','lunas',5000,3600,3600,0,1400,'2024-09-03 07:14:37','13',NULL,NULL);
...
-- Dump completed on 2024-09-03  9:25:06
