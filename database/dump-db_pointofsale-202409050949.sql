...
INSERT INTO `tbl_trn_detail_sales` VALUES (64,'2024-09-05 00:00:00',34,1,'Mie Rasa Pedas',1,'PCS','AL091','Indofood1',2000,2,0,'2024-09-05 09:26:41','13',NULL,NULL),(65,'2024-09-05 00:00:00',35,1,'Mie Rasa Pedas',1,'PCS','AL091','Indofood1',2000,2,0,'2024-09-05 09:36:01','13',NULL,NULL);
...
--
-- Temporary table structure for view `vw_stock_item`
--

DROP TABLE IF EXISTS `vw_stock_item`;
/*!50001 DROP VIEW IF EXISTS `vw_stock_item`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_stock_item` (
  `id` tinyint NOT NULL,
  `name_item` tinyint NOT NULL,
  `barcode` tinyint NOT NULL,
  `kode_item` tinyint NOT NULL,
...
-- Dump completed on 2024-09-05  9:49:30
